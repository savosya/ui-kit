...
export const CheckIcon = ({size, className}: CheckIconProps) => {
  return (
    <svg width={sizeConfig[size].width} height={sizeConfig[size].height} viewBox="0 0 9 6" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={{maxHeight: 'fit-content'}}>
