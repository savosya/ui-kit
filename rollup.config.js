...
const postcssPluginSCSS = cssPath => {
  return postcss({
    ...
    autoModules: false,
    include: ['src/**/*.{scss}'],
    plugins: [postcssImport({}), autoprefixer(), discardEmpty(), discardComments()],
    sourceMap: true,
  ...
  output: [
    {
       ...
       * */
      plugins: [addCssImports({ isEsm: false }), overridePackageJson({ module: 'esm/index.js', main: 'cjs/index.js' })]
    }
  ],
  ...
  output: [
    {
      ...
      plugins: [addCssImports({ isEsm: true })]
    }
  ],
