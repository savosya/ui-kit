try {
  ...
  var S = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
    ...
    Ky = (e, t, r, n) => {
      if ((t && typeof t == 'object') || typeof t == 'function')
        for (let a of Wy(t))
          !Vy.call(e, a) && a !== r && ya(e, a, { get: () => t[a], enumerable: !(n = zy(t, a)) || n.enumerable })
      return e
    }
  var fe = (e, t, r) => (
    (r = e != null ? Hy(Gy(e)) : {}),
  ...
  var Pe,
    ...
    Ua = Ze(() => {
      ...
      c()
      d()
      ;(Pe = e => `control-${e.replace(/\s+/g, '-')}`), (hr = e => `set-${e.replace(/\s+/g, '-')}`)
    })
  var Dk,
    Ck,
    xk,
  ...
  var Gs = S((jL, Ws) => {
    ...
    var zs = Hs(),
      ...
      cb = rn()
    function db() {
      ;(this.size = 0), (this.__data__ = { hash: new zs(), map: new (cb || lb)(), string: new zs() })
    }
    Ws.exports = db
  })
  var Ks = S((HL, Vs) => {
  ...
  var pn = S((a$, Vl) => {
    ...
    function JA(e, t) {
      var r = typeof e
      return (t = t ?? YA), !!t && (r == 'number' || (r != 'symbol' && XA.test(e))) && e > -1 && e % 1 == 0 && e < t
    }
    Vl.exports = JA
  })
  var fn = S((s$, Kl) => {
  ...
  var Nc = S((TU, kc) => {
    ...
    function jD(e, t, r, n, a, o) {
      ...
      if (m && !y) return o || (o = new Fo()), i || ND(e) ? PD(e, t, r, n, a, o) : ID(e, t, s, r, n, a, o)
      if (!(r & MD)) {
  ...
  var So = S((PU, jc) => {
    ...
    function Lc(e, t, r, n, a) {
      return e === t ? !0 : e == null || t == null || (!Mc(e) && !Mc(t)) ? e !== e && t !== t : qD(e, t, r, n, Lc, a)
    }
    jc.exports = Lc
  })
  var $c = S((MU, qc) => {
  ...
  var bd = S((JH, Ed) => {
    ...
    function WC(e, t, r) {
      ...
      return o || ++n != a ? o : ((a = e == null ? 0 : e.length), !!a && HC(a) && UC(i, a) && ($C(e) || qC(e)))
    }
    Ed.exports = WC
  })
  var _o = S((tz, Ad) => {
  ...
  var An = S((Pz, Pd) => {
    ...
    var Rd = Po()
    function Dx(e, t, r) {
      t == '__proto__' && Rd ? Rd(e, t, { configurable: !0, enumerable: !0, value: r, writable: !0 }) : (e[t] = r)
    }
    Pd.exports = Dx
  })
  var vn = S((Mz, Id) => {
  ...
  var cf = S((aV, lf) => {
    ...
    function yw(e) {
      ...
      return t && typeof e[0] == 'string' && gw.call(e, 'index') && ((r.index = e.index), (r.input = e.input)), r
    }
    lf.exports = yw
  })
  var wn = S((sV, pf) => {
  ...
  var _0 = S((MY, T0) => {
    ...
    var gB = w0(),
      ...
      EB = B0
        ? function (e, t) {
            return B0(e, 'toString', { configurable: !0, enumerable: !1, value: gB(t), writable: !0 })
          }
        : yB
    T0.exports = EB
  })
  ...
  var lh = S((dJ, sh) => {
    ...
    sh.exports = function (t) {
      ...
      for (
        ...
        u.push('$' + s)
      if (
        ((a = Function('binder', 'return function (' + u.join(',') + '){ return binder.apply(this,arguments); }')(o)),
        r.prototype)
      ) {
        var p = function () {}
  ...
  var zn = S((CJ, yh) => {
    ...
    yh.exports = function (t, r) {
      ...
      for (var y = 1, b = !0; y < n.length; y += 1) {
        ...
        if (((m === 'constructor' || !b) && (s = !0), (a += '.' + m), (i = '%' + a + '%'), Un(St, i))) u = St[i]
        else if (u != null) {
          if (!(m in u)) {
  ...
  var Kh = S((qJ, Vh) => {
    ...
    var yi = typeof Map == 'function' && Map.prototype,
      si = Object.getOwnPropertyDescriptor && yi ? Object.getOwnPropertyDescriptor(Map.prototype, 'size') : null,
      Vn = yi && si && typeof si.get == 'function' ? si.get : null,
      Th = yi && Map.prototype.forEach,
      Ei = typeof Set == 'function' && Set.prototype,
      li = Object.getOwnPropertyDescriptor && Ei ? Object.getOwnPropertyDescriptor(Set.prototype, 'size') : null,
      ...
      fi = typeof Symbol == 'function' && typeof Symbol.iterator == 'symbol' ? Symbol.prototype.toString : null,
      er = typeof Symbol == 'function' && typeof Symbol.iterator == 'object',
      we =
        typeof Symbol == 'function' && Symbol.toStringTag && (typeof Symbol.toStringTag === er || 'symbol')
          ? Symbol.toStringTag
          : null,
      ...
      kh =
        ...
        ([].__proto__ === Array.prototype
          ...
          : null)
    function Nh(e, t) {
      if (e === 1 / 0 || e === -1 / 0 || e !== e || (e && e > -1e3 && e < 1e3) || $h.call(/e/, t)) return t
    ...
    Vh.exports = function e(t, r, n, a) {
      ...
      if ((typeof n > 'u' && (n = 0), n >= y && y > 0 && typeof t == 'object')) return mi(t) ? '[Array]' : '[Object]'
      var b = ZT(o, n)
      if (typeof a > 'u') a = []
      ...
      if (XT(t)) {
        for (var x = '<' + Rh.call(String(t.nodeName)), F = t.attributes || [], B = 0; B < F.length; B++)
      ...
      if (!MT(t) && !jh(t)) {
        var N = Gn(t, m),
          ...
          ee = U || typeof t.constructor != 'function' ? '' : t.constructor.name ? t.constructor.name + ' ' : '',
          Q = ee + (H || V ? '[' + Ye.call(Ph.call([], H || [], V || []), ': ') + '] ' : '')
        return N.length === 0 ? Q + '{}' : b ? Q + '{' + gi(N, b) + '}' : Q + '{ ' + Ye.call(N, ', ') + ' }'
      }
      return String(t)
    }
    function Hh(e, t, r) {
      ...
      for (var s in e)
        pt(e, s) &&
          ((r && String(Number(s)) === s && s < e.length) ||
            ...
            ($h.call(/[^\w$]/, s) ? n.push(t(s, e) + ': ' + t(e[s], e)) : n.push(s + ': ' + t(e[s], e))))
      if (typeof ci == 'function')
        for (var p = 0; p < o.length; p++) Uh.call(e, o[p]) && n.push('[' + t(o[p]) + ']: ' + t(e[o[p]], e))
      return n
    }
  })
  var Xh = S((zJ, Yh) => {
  ...
  var om = S((rQ, am) => {
    ...
    var rm = Xh(),
      ...
      B_ = function e(t, r, n, a, o, i, u, s, p, y, b, m, g, A, E, x) {
        ...
        var U
        if (n === 'comma' && at(F))
          A && u && (F = Qn.maybeMap(F, u)), (U = [{ value: F.length > 0 ? F.join(',') || null : void 0 }])
        else if (at(s)) U = s
        else {
          var V = Object.keys(F)
          U = p ? V.sort(p) : V
        ...
        for (var H = a && at(F) && F.length === 1 ? r + '[]' : r, ee = 0; ee < U.length; ++ee) {
          ...
          if (!(i && Y === null)) {
            var R = at(F) ? (typeof n == 'function' ? n(H, Q) : H) : H + (y ? '.' + Q : '[' + Q + ']')
            x.set(t, I)
            var _ = rm()
            _.set(Fi, x), nm(N, e(Y, R, n, a, o, i, n === 'comma' && A && at(F) ? null : u, s, p, y, b, m, g, A, E, _))
          }
        }
        return N
      },
      T_ = function (t) {
        ...
        if (typeof t.format < 'u') {
          if (!x_.call($r.formatters, t.format)) throw new TypeError('Unknown format option provided.')
          n = t.format
        }
    ...
    var rr = xi(),
      ...
      I_ = function (t, r) {
        ...
        if (r.charsetSentinel)
          for (s = 0; s < i.length; ++s)
            i[s].indexOf('utf8=') === 0 &&
              (i[s] === P_ ? (p = 'utf-8') : i[s] === R_ && (p = 'iso-8859-1'), (u = s), (s = i.length))
        for (s = 0; s < i.length; ++s)
          if (s !== u) {
            var y = i[s],
              b = y.indexOf(']='),
      ...
      N_ = function (t, r, n, a) {
        if (t) {
          ...
          for (var b = 0; n.depth > 0 && (s = u.exec(o)) !== null && b < n.depth; ) {
            if (((b += 1), !n.plainObjects && Si.call(Object.prototype, s[1].slice(1, -1)) && !n.allowPrototypes))
              return
            y.push(s[1])
          }
      ...
      M_ = function (t) {
        ...
        return {
          ...
          delimiter: typeof t.delimiter == 'string' || rr.isRegExp(t.delimiter) ? t.delimiter : Ce.delimiter,
  ...
  var Em = S((nee, ym) => {
    ...
    ;(function () {
      ...
      function u(m) {
        ...
        for (g = 1, A = m.length; g < A; ++g) if (((E = m.charCodeAt(g)), !e.isIdentifierPartES5(E))) return !1
        return !0
      }
      function s(m, g) {
      ...
      function F() {
        ...
        for (P = r.charAt(a), ++a; a < n; )
          if (((M = E()), M === P)) {
            ...
            if (((M = E()), s.code.isLineTerminator(M.charCodeAt(0)))) M === '\r' && r.charCodeAt(a) === 10 && ++a
            else
              switch (M) {
                case 'n':
                  T += `
`
      ...
      function B() {
        ...
        if (P === 46) for (T += E(); a < n && ((P = r.charCodeAt(a)), !!s.code.isDecimalDigit(P)); ) T += E()
        if (P === 101 || P === 69)
          if (
            ((T += E()),
            (P = r.charCodeAt(a)),
        ...
        switch (((T = r.charCodeAt(a)), T)) {
          ...
          case 46:
            if (a + 1 < n) {
              ...
              if (T === 46 && a + 2 < n && r.charCodeAt(a + 2) === 46) return E(), E(), E(), (i = t.REST), i
      ...
      function R() {
        ...
        return (
          (T = Q()),
          i === t.DOT_LT || i === t.LT
            ? (L(), (P = Y()), k(t.GT), A({ type: e.TypeApplication, expression: T, applications: P }, [M, o]))
            : T
        )
      }
      function _() {
        ...
        return (
          ...
          i !== t.RPAREN &&
            (i === t.NAME && (u === 'this' || u === 'new')
              ? ((T = u === 'new'), w(t.NAME), k(t.COLON), (P = R()), i === t.COMMA && (w(t.COMMA), (M = q())))
              : (M = q())),
          k(t.RPAREN),
          (O = null),
          i === t.COLON && (O = _()),
      ...
      function ke(T, P) {
        ...
        return (
          ...
          L(),
          (M = Z()),
          P && P.midstream ? { expression: M, index: o } : (i !== t.EOF && p.throwError('not reach to EOF'), M)
        )
      }
      function Ne(T, P) {
        var M
...
\u2028\u2029])`
      ...
      function L(w, k) {
        for (var N = w.replace(/^\/\*\*?/, ''), U = 0, V = new RegExp(B, 'g'), H; (H = V.exec(N)); )
          if (((U += H[1].length), H.index + H[0].length > k + U)) return k + U + w.length - N.length
      ...
      ;(function (w) {
        ...
        function W() {
          var M,
            ...
            $ = N
          for (O = !1; $ < V; ) {
            if (((M = H.charCodeAt($)), n.code.isLineTerminator(M) && !(M === 13 && H.charCodeAt($ + 1) === 10))) O = !0
            else if (O) {
              if (M === 64) break
        ...
        function Z(M) {
          for (; N < M && (n.code.isWhiteSpace(H.charCodeAt(N)) || n.code.isLineTerminator(H.charCodeAt(N))); ) _()
        }
        function se(M, O, $) {
          var z = '',
            pe,
        ...
        ;(J.prototype.addError = function (O) {
          ...
          (J.prototype._parseNamePath = function (M) {
            ...
            return (
              ...
              !O && !M && !this.addError('Missing or invalid tag name') ? !1 : ((this._tag.name = O), !0)
            )
          }),
        ...
        function P(M, O) {
          ...
          for (
            V = H.length, N = 0, U = 0, Q = O.recoverable, Y = O.sloppy, R = O.strict, pe = T(O.preserveWhitespace);
            (z = Ue(O)), !!z;
    ...
    Km.exports = function (e) {
      ...
      function p(F) {
        ...
        return (
          ...
          I.setAttribute('class', e.linkClass + i + 'node-name--' + F.nodeName + i + e.extraLinkClasses),
          B.appendChild(I),
          B
        )
      }
      function y(F) {
        ...
        return F && ((L = L + i + e.collapsibleClass), (L = L + i + e.isCollapsedClass)), I.setAttribute('class', L), I
      }
      function b() {
      ...
      function m(F) {
        var B = 0
        return F !== null && ((B = F.offsetTop), e.hasInnerContainers && (B += m(F.offsetParent))), B
      }
      function g(F) {
        if (e.scrollContainer && document.querySelector(e.scrollContainer)) {
          var B
      ...
      function A(F) {
        return F && F.className.indexOf(e.collapsibleClass) !== -1 && F.className.indexOf(e.isCollapsedClass) !== -1
          ? ((F.className = F.className.split(i + e.isCollapsedClass).join('')), A(F.parentNode.parentNode))
          : F
      }
      function E(F) {
  ...
  var tg = S(eg => {
    ...
    function eR(e, t) {
      var r = window.pageYOffset,
        n = { duration: t.duration, offset: t.offset || 0, callback: t.callback, easing: t.easing || b },
        a =
      ...
      ;(dR = typeof window < 'u' ? bu : he),
        ...
        (fR = function (e) {
          ...
          return h.createElement(
            ...
            h.createElement(dg, { hue: p.h, onChange: y, className: 'react-colorful__last-control' })
          )
        }),
        (hR = {
          defaultColor: '000',
        ...
        (mR = function (e) {
          ...
          return h.createElement(
            ...
            h.createElement(
              ...
              h.createElement(Hi, { className: 'react-colorful__alpha-pointer', left: r.a, color: ia(r) })
            )
          )
        }),
        (Eg = function (e) {
  ...
  var zi = S((Dte, Fg) => {
    ...
    for (let e of Object.keys(G)) {
      ...
      if (G[e].labels.length !== G[e].channels) throw new Error('channel and label counts mismatch: ' + e)
  ...
  var wg = S((Ste, Sg) => {
    ...
    function DR(e, t) {
      let r = [t[e].parent, e],
        n = ua[t[e].parent][e],
        a = t[e].parent
      for (; t[a].parent; ) r.unshift(t[a].parent), (n = vR(ua[t[a].parent][a], n)), (a = t[a].parent)
    ...
    Jg = Ze(() => {
      ...
      ;(XR = j.div({ position: 'relative', maxWidth: 250 })),
        ...
        (Wg = ({ value: e, active: t, onClick: r, style: n, ...a }) => {
          ...
          return h.createElement(t4, { ...a, active: t, onClick: r, style: { ...n, backgroundImage: o } })
        }),
        ...
        (lr = e => {
          ...
          let r = e.replace('#', ''),
            ...
            o = e
          if ((/[^#a-f0-9]/i.test(e) ? (o = r) : Vi.test(e) && (o = `#${r}`), o.startsWith('#'))) t = Vi.test(o)
          else
            try {
        ...
        (p4 = (e, t, r) => {
          ...
          let o = ot(
              () =>
                (e || [])
                  .map(u =>
                    typeof u == 'string' ? lr(u) : u.title ? { ...lr(u.color), keyword: u.title } : lr(u.color)
                  )
                  .concat(n)
                  .filter(Boolean)
                  .slice(-27),
        ...
        (Yg = ({ name: e, value: t, onChange: r, onFocus: n, onBlur: a, presetColors: o, startOpen: i = !1 }) => {
          let u = ge((0, Vg.default)(r, 200), [r]),
            { value: s, realValue: p, updateValue: y, color: b, colorSpace: m, cycleColorSpace: g } = d4(t, u),
  ...
  function Za(e, t, r) {
    if (typeof e == 'number' && typeof t == 'number' && typeof r == 'number') return Qa('#' + bt(e) + bt(t) + bt(r))
    if (typeof e == 'object' && t === void 0 && r === void 0) return Qa('#' + bt(e.red) + bt(e.green) + bt(e.blue))
    throw new Ie(6)
  }
  function He(e, t, r, n) {
  ...
  var dF = Object.create,
    ...
    yF = (e, t, r, n) => {
      if ((t && typeof t == 'object') || typeof t == 'function')
        for (let a of fF(t))
          !mF.call(e, a) && a !== r && Yd(e, a, { get: () => t[a], enumerable: !(n = pF(t, a)) || n.enumerable })
      return e
    },
    EF = (e, t, r) => (
      (r = e != null ? dF(hF(e)) : {}),
...
`,
      ...
      if (E.length > 1 || t.forceWrapper) F = E
        ...
        if (E.length === 1) return (F = E[0]), typeof F == 'string' ? n('span', { key: 'outer' }, F) : F
        F = null
      }
        ...
        ? A.reduce(function (E, x, F) {
            ...
            if (B !== -1) {
              let I = (function (N) {
                ...
                L = (function (N) {
                  let U = N[0]
                  return (U === '"' || U === "'") && N.length >= 2 && N[N.length - 1] === U ? N.slice(1, -1) : N
                })(x.slice(B + 1).trim()),
                w = Jd[I] || I,
                k = (E[w] = (function (N, U) {
                  return N === 'style'
                    ? U.split(/;\s?/).reduce(function (V, H) {
                        ...
                        return (V[ee.replace(/(-[a-z])/g, Q => Q[1].toUpperCase())] = H.slice(ee.length + 1).trim()), V
                      }, {})
                    : N === 'href'
                    ? Gt(U)
                    : (U.match(LF) && (U = U.slice(1, U.length - 1)), U === 'true' || (U !== 'false' && U))
                })(I, L))
              typeof k == 'string' && (Ho.test(k) || zo.test(k)) && (E[w] = me(a(k.trim()), { key: F }))
    ...
    let i = [],
      ...
      s = {
        ...
        codeBlock: {
          ...
          h: (g, A, E) => n('pre', { key: E.k }, n('code', Ct({}, g.O, { className: g.M ? `lang-${g.M}` : '' }), g.v))
        },
        codeFenced: {
          t: nt(op),
          i: re.MAX,
        ...
        codeInline: { t: dt(TF), i: re.LOW, l: g => ({ v: g[2] }), h: (g, A, E) => n('code', { key: E.k }, g.v) },
        ...
        image: {
          ...
          h: (g, A, E) => n('img', { key: E.k, alt: g.D || void 0, title: g.F || void 0, src: Gt(g.B) })
        },
        link: {
          t: ct(fS),
          i: re.LOW,
...
`
        ...
        text: {
          t: _r(iS),
          i: re.MIN,
          l: g => ({ v: g[0].replace(NF, (A, E) => (t.namedCodesToUnicode[E] ? t.namedCodesToUnicode[E] : A)) }),
          h: g => g.v
        },
        textBolded: {
          t: dt(tS),
        ...
        textMarked: { t: dt(nS), i: re.LOW, l: jo, h: (g, A, E) => n('mark', { key: E.k }, A(g.v, E)) },
        textStrikethroughed: { t: dt(aS), i: re.LOW, l: jo, h: (g, A, E) => n('del', { key: E.k }, A(g.v, E)) }
      }
...
`
  ...
  var j3 = Object.create,
    ...
    H3 = (e, t, r, n) => {
      if ((t && typeof t == 'object') || typeof t == 'function')
        for (let a of e0(t))
          !U3.call(e, a) && a !== r && Zf(e, a, { get: () => t[a], enumerable: !(n = q3(t, a)) || n.enumerable })
      return e
    },
    t0 = (e, t, r) => (
      (r = e != null ? j3($3(e)) : {}),
    ...
    var a = n.reduce(function (u, s) {
      ...
      return p
        ? u.concat(
            p.map(function (y) {
              var b, m
              return (m = (b = y.match(/[\t ]/g)) === null || b === void 0 ? void 0 : b.length) !== null && m !== void 0
                ? m
                : 0
            })
          )
...
`)),
  ...
  var J0 = fe(K0(), 1)
  var Q0 = fe(Mo(), 1)
  var zX = (0, X0.default)(1)(e => Object.values(e).reduce((t, r) => ((t[r.importPath] = t[r.importPath] || r), t), {}))
...
`,
    ...
    iT = (e, t, r) => {
      ...
      if (n) {
        if (r.color && r.color.test(t)) {
          ...
          o !== 'enum' && Ve.warn(`Addon controls: Control of type color only supports string, received "${o}" instead`)
        }
  ...
  function ni(e) {
    ...
    return {
      ...
      decorators: Mn(e, 'decorators', { reverseFileOrder: !(ue.FEATURES?.legacyDecoratorFileOrder ?? !1) }),
      args: Ln(e, 'args'),
    ...
    cm = Ke({
      '../../node_modules/entities/lib/decode.js'(e) {
        ...
        e.decodeHTML = (function () {
          for (
            var y = Object.keys(n.default).sort(s), b = Object.keys(r.default).sort(s), m = 0, g = 0;
            m < b.length;
            m++
          )
            y[g] === b[m] ? ((b[m] += ';?'), g++) : (b[m] += ';')
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)
        ...
        function Q(R, _, q) {
          return _ !== 'text' && ((R = R.filter(I(L(q)))), R.push({ token: _, data: q, category: L(q) })), R
        }
        var Y = (function () {
          function R(_) {
            r(this, R),
  ...
  var d8 = Object.create,
    ...
    m8 = (e, t, r, n) => {
      if ((t && typeof t == 'object') || typeof t == 'function')
        for (let a of Sm(t))
          !h8.call(e, a) && a !== r && Fm(e, a, { get: () => t[a], enumerable: !(n = p8(t, a)) || n.enumerable })
      return e
    },
    ta = (e, t, r) => (
      (r = e != null ? d8(f8(e)) : {}),
        ...
        t.exports = function (Y, R) {
          ...
          for (var ke = 1, Ne = !0; ke < _.length; ke += 1) {
            var J = _[ke],
              Ue = k(J, 0, 1),
              T = k(J, -1)
            if ((Ue === '"' || Ue === "'" || Ue === '`' || T === '"' || T === "'" || T === '`') && Ue !== T)
              throw new n('property names with quotes must have matching quotes')
            if (((J === 'constructor' || !Ne) && (Z = !0), (q += '.' + J), (X = '%' + q + '%'), B(A, X))) K = A[X]
            else if (K != null) {
              if (!(J in K)) {
...
` &&
  ...
  var Ee = e => `& :where(${e}:not(.sb-anchor, .sb-unstyled, .sb-unstyled ${e}))`,
    ...
    wre = j.h1(Pt, ({ theme: e }) => ({
      ...
      lineHeight: '32px',
      [`@media (min-width: ${ou}px)`]: { fontSize: e.typography.size.l1, lineHeight: '36px', marginBottom: '16px' }
    })),
    Bre = j.h2(Pt, ({ theme: e }) => ({
      ...
      borderBottom: 'none',
      marginBottom: 15,
      [`@media (min-width: ${ou}px)`]: { fontSize: e.typography.size.m1, lineHeight: '28px', marginBottom: 24 },
  ...
  var ma = e => ({
    ...
    b4 = j(Ba)({ position: 'absolute', left: 0, right: 0, top: 0, transition: 'transform .2s linear' }),
    A4 = ({ isLoading: e, storyId: t, baseUrl: r, zoom: n, resetZoom: a, ...o }) =>
      h.createElement(
        ...
        h.createElement(
          gu,
          { key: 'left' },
          e ? [1, 2, 3].map(i => h.createElement(Oa, { key: i })) : h.createElement(E4, { zoom: n, resetZoom: a })
        )
      ),
    by = pr({ scale: 1 }),
    { window: v4 } = ue,
  ...
  var R4 = j(A4)({ position: 'absolute', top: 0, left: 0, right: 0, height: 40 }),
    ...
    ey = (e, t = !0) => {
      let r = e
      return t || (r = e.slice(0, Zi)), r.map(n => h.createElement(Ay, { key: n, text: n === '' ? '""' : n }))
    },
    G4 = ({ value: e, initialExpandedArgs: t }) => {
      ...
      if (n == null) {
        ...
        return y > Zi
          ? h.createElement(
              ...
              { isExpanded: i },
              ey(p, i),
              h.createElement(j4, { onClick: () => u(!i) }, i ? 'Show less...' : `Show ${y - Zi} more...`)
            )
      ...
      return h.createElement(
        Ma,
        {
          ...
          tooltip: h.createElement($4, { width: z4(n) }, h.createElement(Qr, { language: 'jsx', format: !1 }, n))
        },
        h.createElement(
          q4,
    ...
    Ki = ({ value: e, initialExpandedArgs: t }) =>
      e == null ? h.createElement(H4, null) : h.createElement(G4, { value: e, initialExpandedArgs: t }),
    V4 = j.label(({ theme: e }) => ({
      lineHeight: '18px',
      alignItems: 'center',
      marginBottom: 8,
    ...
    t9 = ({ name: e, value: t, onChange: r, onFocus: n, onBlur: a }) => {
      let [o, i] = ne(!0),
        ...
        s = Fe()
      he(() => {
        o !== !1 && (u && u.current && (u.current.value = Q4(t)), s && s.current && (s.current.value = Z4(t)))
      }, [t])
      let p = m => {
  ...
  var a9 = ({ name: e, value: t, onChange: r, min: n, max: a, step: o, onBlur: i, onFocus: u }) => {
    ...
    m9 = { check: ty, 'inline-check': ty, radio: ry, 'inline-radio': ry, select: ay, 'multi-select': ay },
    cr = e => {
    ...
    handleAddValueAdd({ newValue: e }) {
      ...
      a(t.length, r, n, e)
        .then(() => {
          ...
          u(r[r.length - 1], i), s({ type: Fy, keyPath: r, deep: n, key: i.length - 1, newValue: e })
        })
        .catch(o.error)
    }
      ...
      return new Promise((r, n) => {
        ...
        a(e, i, u, s, t)
          .then(() => {
            ...
            p(i[i.length - 1], o), y({ type: wy, keyPath: i, deep: u, key: e, newValue: t, oldValue: s }), r(void 0)
          })
          .catch(n)
      })
    }
  ...
  var _y = class extends et {
    ...
    render() {
      ...
      if (r && !B) {
        ...
        ;(x = h.createElement('span', { className: 'rejt-edit-form', style: E.editForm }, k, ' ', w, L)), (F = null)
      } else {
        x = h.createElement(
          'span',
      ...
      return new Promise((r, n) => {
        ...
        a(e, i, u, s, t)
          .then(() => {
            ;(o[e] = t), this.setState({ data: o })
            let { onUpdate: p, onDeltaUpdate: y } = this.props
            p(i[i.length - 1], o), y({ type: wy, keyPath: i, deep: u, key: e, newValue: t, oldValue: s }), r()
          })
          .catch(n)
      })
    }
  ...
  var mt = class extends et {
    ...
    render() {
      ...
      return h.createElement(
        ...
        h.createElement('span', { className: 'rejt-name', style: E.name }, e, ' : '),
        F
          ? h.createElement('span', { className: 'rejt-edit-form', style: E.editForm }, w, ' ', L, I)
          : h.createElement(
              'span',
  ...
  var z9 = ({ name: e, value: t, onChange: r, min: n = 0, max: a = 100, step: o = 1, onBlur: i, onFocus: u }) => {
      let s = b => {
          r(n9(b.target.value))
        },
        p = t !== void 0,
      ...
      return h.createElement(
        ...
        h.createElement($9, { numberOFDecimalsPlaces: y, max: a }, p ? t.toFixed(y) : '--', ' / ', a)
      )
    },
    W9 = j.label({ display: 'flex' }),
    G9 = j.div(({ isMaxed: e }) => ({ marginLeft: '0.75rem', paddingTop: '0.35rem', color: e ? 'red' : void 0 })),
  ...
  var X9 = ({ onChange: e, name: t, accept: r = 'image/*', value: n }) => {
    ...
    Q9 = e => h.createElement(yu, { fallback: h.createElement('div', null) }, h.createElement(J9, { ...e })),
    Z9 = {
      array: uy,
      object: uy,
      boolean: Y4,
    ...
    rP = j.span(({ theme: e }) => ({ color: e.color.negative, fontFamily: e.typography.fonts.mono, cursor: 'help' })),
    nP = j.div(({ theme: e }) => ({
    ...
    iP = j.td(({ theme: e, expandable: t }) => ({ paddingLeft: t ? '40px !important' : '20px !important' })),
    pa = e => {
      let [t, r] = ne(!1),
        ...
        o
          ...
          : h.createElement(
              ...
              y.jsDocTags != null
                ...
                : h.createElement(aP, { hasDescription: A }, h.createElement(Ki, { value: b, initialExpandedArgs: u }))
            ),
        o ? null : h.createElement('td', null, h.createElement(Ki, { value: m, initialExpandedArgs: u })),
    ...
    Xi = ({ level: e = 'section', label: t, children: r, initialExpanded: n = !0, colSpan: a = 3 }) => {
      let [o, i] = ne(n),
      ...
      return h.createElement(
        ...
        h.createElement(
          ...
          h.createElement(
            dP,
            { colSpan: a - 1 },
            h.createElement(ly, { onClick: m => i(!o), tabIndex: -1, style: { outline: 'none' } }, b),
            o ? null : p
          )
        ),
        o ? r : null
    ...
    EP = j.div(({ theme: e }) => ({ display: 'flex', fontSize: e.typography.size.s2 - 1, gap: 25 })),
      ...
      return h.createElement(
        ...
        h.createElement(
          ...
          h.createElement(
            ...
            b.ungrouped.map(B => h.createElement(pa, { key: B.key, row: B, arg: p && p[B.key], ...F })),
            Object.entries(b.ungroupedSubsections).map(([B, I]) =>
              h.createElement(
                Xi,
                { key: B, label: B, level: 'subsection', colSpan: E },
                I.map(L => h.createElement(pa, { key: L.key, row: L, arg: p && p[L.key], expandable: x, ...F }))
              )
            ),
            Object.entries(b.sections).map(([B, I]) =>
              h.createElement(
                ...
                I.ungrouped.map(L => h.createElement(pa, { key: L.key, row: L, arg: p && p[L.key], ...F })),
                Object.entries(I.subsections).map(([L, w]) =>
                  h.createElement(
                    Xi,
                    { key: L, label: L, level: 'subsection', colSpan: E },
                    w.map(k => h.createElement(pa, { key: k.key, row: k, arg: p && p[k.key], expandable: x, ...F }))
                  )
                )
              )
            )
  ...
  var kre = j.div(({ theme: e }) => ({ fontWeight: e.typography.weight.bold, color: e.color.defaultText })),
    Nre = j.div(({ theme: e }) => ({
    ...
    Ure = j.div({ display: 'flex', flexDirection: 'column', flex: 1, position: 'relative', marginBottom: 30 }),
  ...
  var wP = e => `anchor--${e}`,
    BP = ({ storyId: e, children: t }) => h.createElement('div', { id: wP(e), className: 'sb-anchor' }, t)
  ue &&
  ...
  var _P = (e, t) => {
    ...
    ru = (e, t, r, n, a, o) => ({ ...e, ...(0, gy.default)(t, i => ({ rows: Ny(i, r, n, a), sort: o })) }),
    PP = e => {
      let t = qe(Qe),
      ...
      try {
        ...
        if (
          (B || ((m = null), (g = null), (F = {})), n && (!B || o) && (F = ru(F, { [x]: n }, y.parameters, i, u)), a)
        ) {
          if (Array.isArray(a))
            throw new Error(
...
`))
  ...
  var Ly = (e, t) => {
    ...
    zP = ({ withSource: e, mdxSource: t, children: r, layout: n, ...a }, o, i) => {
      ...
      return (
        ...
        {
          isLoading: p,
          previewProps: { ...a, layout: b ?? 'padded', withSource: y, isExpanded: (e || y.state) === 'open' }
        }
      )
    },
    WP = e => {
  ...
  var nu = ja.a,
    ...
    ZP = e => {
      ...
      return h.createElement(Vo, {
        ...e,
        options: { forceBlock: !0, overrides: { code: GP, a: KP, ...QP, ...e?.options?.overrides }, ...e?.options }
      })
    },
    eI = (e => ((e.INFO = 'info'), (e.NOTES = 'notes'), (e.DOCGEN = 'docgen'), (e.AUTO = 'auto'), e))(eI || {}),
    ha =
    ...
    oI = ({ type: e, markdown: t, children: r }, { storyById: n }) => {
      ...
      ;(i || u) &&
        ye(`Using 'parameters.notes' or 'parameters.info' properties to describe stories is deprecated. See ${ha}`)
    ...
    Zre = j.div(({ theme: e }) => ({ width: '10rem', '@media (max-width: 768px)': { display: 'none' } })),
    ene = j.div(({ theme: e }) => ({
      position: 'fixed',
      top: 0,
      width: '10rem',
  ...
  var uI = ({ children: e, disableAnchor: t }) => {
    ...
    sI = ({ of: e, expanded: t = !0, withToolbar: r = !1, __forceInitialArgs: n = !1, __primary: a = !1 }) => {
      let { story: o } = lu(e || 'story', ['story']),
        i = o.parameters.docs?.canvas?.withToolbar ?? r
      return h.createElement(
        BP,
        { storyId: o.id },
        t && h.createElement(h.Fragment, null, h.createElement(uI, null, o.name), h.createElement(iI, { of: e })),
        h.createElement(WP, {
          of: e,
          withToolbar: i,
      ...
      return (
        ...
        !n || n.length === 0
          ...
          : h.createElement(
              ...
              n.map(
                a => a && h.createElement(sI, { key: a.id, of: a.moduleExport, expanded: !0, __forceInitialArgs: !0 })
              )
            )
      )
    }
  ...
  va.register(Ea, e => {
    va.add(Ea, {
      ...
      paramKey: ba,
      render: ({ active: t }) =>
        !t || !e.getCurrentStoryData() ? null : h.createElement(xa, { active: t }, h.createElement(pI, null))
    })
  })
} catch (e) {
