import { j as v } from './jsx-runtime-276775ef.js'
import { a as k, r as s } from './index-1cdf6ce0.js'
import { c as d } from './clsx.m-1229b3e0.js'
import { _ as I } from './tslib.es6-6635c9de.js'
import { u as j, m as B } from './mergeRefs-3b77d02e.js'
const b = { s: { width: '10', height: '10' }, m: { width: '11', height: '11' }, l: { width: '12', height: '12' } },
  w = ({ size: t, className: l }) =>
    k.createElement(
      'svg',
      {
        width: b[t].width,
...
w.__docgenInfo = { description: '', methods: [], displayName: 'CheckIcon' }
const e = {
  ...
  x = s.forwardRef((t, l) => {
    ...
    return s.createElement(
      ...
      s.createElement(
        ...
        i && n === 'check' && s.createElement(w, { size: r }),
...
x.__docgenInfo = { description: '', methods: [], displayName: 'Radio' }
...
export { N as R }
//# sourceMappingURL=Component-1bfaf9fc.js.map
