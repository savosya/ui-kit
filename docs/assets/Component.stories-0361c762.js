import { a as s, j as e } from './jsx-runtime-37f7df21.js'
import { r as d } from './index-f1f2c4b1.js'
import { A as i } from './Component-8fb68d72.js'
import { B as R } from './Component-723ebd17.js'
import { L } from './Component-0fc422e6.js'
import './clsx.m-1229b3e0.js'
import './mergeRefs-dc8f3646.js'
import './Component-856ebfaa.js'
import './tslib.es6-6635c9de.js'
const M = { title: 'Accordion', component: i, argTypes: { chevroneIcon: { control: 'text' } } },
  n = {
    args: {
      title: 'Star Wars',
  ...
  o = {
    render: () => {
      ...
      return s('div', {
        ...
        children: [
          e(R, { onClick: () => t(!a), children: a ? 'Закрыть' : 'Открыть' }),
          e(i, {
            title: 'Подробнее',
            open: a,
            children:
    ...
    render: () => {
      ...
      return s('div', {
        ...
        children: [
          e(R, {
            onClick: () => {
              t || setTimeout(() => l(!0), 2e3), T(!t)
            },
            children: t ? 'Свернуть' : 'Развернуть'
          }),
          e(i, {
            title: 'Аккордион',
            open: t,
            onVisibleChange: C => {
              C && setTimeout(() => l(!1), 500)
            },
            children: e('div', { children: A ? e(a, {}) : e(L, {}) })
          })
        ]
      })
    }
...
n.parameters = {
  ...
  argTypes: {
    ...
    description: {
      story: 'description',
      ...((x = (m = n.parameters) == null ? void 0 : m.docs) == null ? void 0 : x.description)
    }
  }
}
var g, f, E
...
const V = ['Sandbox', 'Controlled', 'Dynamic']
export { o as Controlled, r as Dynamic, n as Sandbox, V as __namedExportsOrder, M as default }
//# sourceMappingURL=Component.stories-0361c762.js.map
