...
import { f as m, M as p, h as u } from './index-089bb4e8.js'
import { C as x } from './css-vars.module-a69f3204.js'
import { s as b, T as f } from './Tabs-8b018486.js'
import './index-f1f2c4b1.js'
import { C as g, T as l, a as h, S as o } from './Component.stories-90a1efe4.js'
...
function r(e) {
  const n = Object.assign({ pre: 'pre', code: 'code' }, a(), e.components)
  return t(n.pre, {
    children: t(n.code, {
...
function $(e = {}) {
  const { wrapper: n } = Object.assign({}, a(), e.components)
  return n ? t(n, Object.assign({}, e, { children: t(r, e) })) : r(e)
}
function s(e) {
  const n = Object.assign({ h3: 'h3' }, a(), e.components)
  return i(d, {
    children: [
...
function c(e) {
  const n = Object.assign({ p: 'p', pre: 'pre', code: 'code' }, a(), e.components)
  return i(d, {
    children: [
...
`,
      t(n.pre, {
        children: t(n.code, {
          ...
          children: `import { Textarea } from '@eubank/kit-ui'
...
`
      ...
      `
`,
      t(m, Object.assign({ of: o, meta: l }, b)),
      `
`,
      t(f, { docs: t(w, {}), props: t(u, { of: o }), css: t($, {}) })
    ]
  })
}
function V(e = {}) {
...
export { V as default }
//# sourceMappingURL=docs-7f4aafc3.js.map
