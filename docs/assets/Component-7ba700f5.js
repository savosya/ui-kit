import { a as m, j as l } from './jsx-runtime-276775ef.js'
import { r as f } from './index-1cdf6ce0.js'
import { c as o } from './clsx.m-1229b3e0.js'
const y = '_root_2w71y_6',
  _ = '_spin_2w71y_1',
  w = '_wrapper_2w71y_10',
  s = { root: y, spin: _, wrapper: w },
  t = a => {
    const {
        size: r = 24,
        color: i = 'currentColor',
        secondaryColor: p = '#B7B9BD',
        className: d,
        fill: c = !0,
        spinner: u,
        classes: e = {},
      ...
      n = f.useMemo(
        () =>
          m('svg', {
            ...
            className: o(s.root, e == null ? void 0 : e.loader),
    ...
    return c ? l('div', { className: o(s.wrapper, d, e == null ? void 0 : e.wrapper), children: n }) : n
  }
try {
  ;(t.displayName = 'Loader'),
    (t.__docgenInfo = {
      description: '',
      displayName: 'Loader',
      props: {
        className: { defaultValue: null, description: '', name: 'className', required: !1, type: { name: 'string' } },
        size: { defaultValue: null, description: '', name: 'size', required: !1, type: { name: 'number' } },
        ...
        spinner: { defaultValue: null, description: '', name: 'spinner', required: !1, type: { name: 'boolean' } },
        ...
        classes: {
          ...
          name: 'classes',
          required: !1,
          type: { name: '{ wrapper?: string; loader?: string; } | undefined' }
        }
      }
    })
} catch {}
export { t as L }
//# sourceMappingURL=Component-7ba700f5.js.map
