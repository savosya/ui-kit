...
import { f as o, M as u, h as l } from './index-089bb4e8.js'
import { C as b } from './css-vars.module-a69f3204.js'
import { s as f, T as h } from './Tabs-8b018486.js'
import './index-f1f2c4b1.js'
import { T as g, I as s, E as y, a as v, b as j, H as x, A as C, c as k, S as a } from './Component.stories-1842103f.js'
import { u as i } from './index-59d6410c.js'
...
function L(e = {}) {
  ...
  return t ? n(t, Object.assign({}, e, { children: n(r, e) })) : r(e)
}
function c(e) {
...
`,
      n(t.pre, {
        children: n(t.code, {
          ...
          children: `import { Input } from '@eubank/kit-ui'
...
`
      ...
      `
`,
      n(o, Object.assign({ of: a, meta: s }, f)),
      `
`,
      n(h, { docs: n(L, {}), props: n(l, { of: a }), css: n(A, {}) })
    ]
  })
}
function on(e = {}) {
...
//# sourceMappingURL=docs-05a457f7.js.map
