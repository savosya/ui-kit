import { j as t, a as c, F as d } from './jsx-runtime-37f7df21.js'
import { f as a, M as b, h as m } from './index-20fbbb8e.js'
import { C as g } from './css-vars.module-a69f3204.js'
import { s as p, T as h } from './Tabs-8b018486.js'
import './index-f1f2c4b1.js'
import { B as y } from './Component-723ebd17.js'
import { P as _, B as e, O as v, G as k, L as f, S as i } from './Component.stories-760267a8.js'
import { u as r } from './index-59d6410c.js'
...
const F = '@savosya/savosya-myuikit-button',
  x = '1.0.1',
  B = 'Button',
  C = 'ISC',
  j = 'index.js',
  D = 'build/esm/index.js',
  ...
  E = { tsc: 'tsc', build: 'rollup -c ../../rollup.config.js' },
...
function l(n) {
  const o = Object.assign({ h3: 'h3' }, r(), n.components)
  return c(d, {
    children: [
      t(o.h3, { id: 'primary-button', children: 'Primary Button' }),
      `
`,
      t(a, { of: _, meta: e }),
      `
...
function N(n = {}) {
  const { wrapper: o } = Object.assign({}, r(), n.components)
  return o ? t(o, Object.assign({}, n, { children: t(l, n) })) : l(n)
}
function s(n) {
  const o = Object.assign({ pre: 'pre', code: 'code' }, r(), n.components)
  return t(o.pre, {
    children: t(o.code, {
...
function S(n = {}) {
  const { wrapper: o } = Object.assign({}, r(), n.components)
  return o ? t(o, Object.assign({}, n, { children: t(s, n) })) : s(n)
}
function u(n) {
  const o = Object.assign({ p: 'p', pre: 'pre', code: 'code' }, r(), n.components)
  return c(d, {
    children: [
      t(b, { title: 'Components/Button', component: y, id: 'Button' }),
      `
`,
      t(g, {
        name: 'Button',
        version: L.version,
        package: '@eubank/kit-button',
        children: t(o.p, { children: 'Компонент кнопки' })
      }),
      `
`,
      t(o.pre, {
        children: t(o.code, {
          ...
          children: `import { Button } from '@eubank/kit-root'
...
`,
      ...
      `
`,
      t(h, { docs: t(N, {}), props: t(m, { of: i }), css: t(S, {}) })
    ]
  })
}
function nt(n = {}) {
  const { wrapper: o } = Object.assign({}, r(), n.components)
  return o ? t(o, Object.assign({}, n, { children: t(u, n) })) : u(n)
}
export { nt as default }
//# sourceMappingURL=docs-84d099cd.js.map
