import { _ as m } from './tslib.es6-6635c9de.js'
import { r as s } from './index-1cdf6ce0.js'
import { c as t } from './clsx.m-1229b3e0.js'
const l = {
    root: 'savosya-loader_root__8kw4',
    spin: 'savosya-loader_spin__vFct',
    wrapper: 'savosya-loader_wrapper__yS7q'
  },
  _ = o => {
    const {
        size: r = 24,
        color: n = 'currentColor',
        secondaryColor: C = '#B7B9BD',
        className: i,
        fill: c = !0,
        spinner: d,
        classes: e = {}
      } = o,
      p = m(o, ['size', 'color', 'secondaryColor', 'className', 'fill', 'spinner', 'classes']),
      a = s.useMemo(
        () =>
          s.createElement(
            'svg',
            Object.assign(
              {
                ...
                className: t(l.root, e == null ? void 0 : e.loader),
    ...
    return c ? s.createElement('div', { className: t(l.wrapper, i, e == null ? void 0 : e.wrapper) }, a) : a
  }
_.__docgenInfo = { description: '', methods: [], displayName: 'Loader' }
export { _ as L }
//# sourceMappingURL=Component-4d843ac5.js.map
