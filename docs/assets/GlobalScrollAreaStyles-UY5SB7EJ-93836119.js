import { a as o } from './index-1cdf6ce0.js'
import { G as s } from './index-01c745a6.js'
...
var a = r => ({
    ...
    '.os-size-observer-listener-item': { right: '0', bottom: '0', overflow: 'hidden', direction: 'ltr', flex: 'none' },
    '.os-size-observer-listener-item-final': { transition: 'none' },
    '@keyframes os-size-observer-appear-animation': { from: { cursor: 'auto' }, to: { cursor: 'none' } },
    '.os-trinsic-observer': {
      flex: 'none',
      boxSizing: 'border-box',
      position: 'relative',
    ...
    '.os-environment,\n[data-overlayscrollbars-viewport]': { msOverflowStyle: 'scrollbar !important' },
    ...
    '.os-scrollbar-track,\n.os-scrollbar-handle': { pointerEvents: 'none', width: '100%', height: '100%' },
    ...
    '.os-scrollbar .os-scrollbar-handle:hover': { border: 'var(--os-handle-border-hover)', opacity: 0.6 },
    ...
    '[data-overlayscrollbars~=updating] > .os-scrollbar,\n.os-theme-none.os-scrollbar': { display: 'none !important' },
    '.os-theme-dark,\n.os-theme-light': {
      boxSizing: 'border-box',
      '--os-size': '10px',
    ...
    '.os-no-css-vars.os-theme-dark:hover .os-scrollbar-handle': { background: 'rgba(0, 0, 0, 0.55)' },
    '.os-no-css-vars.os-theme-dark:active .os-scrollbar-handle': { background: 'rgba(0, 0, 0, 0.66)' },
    '.os-no-css-vars.os-theme-light .os-scrollbar-handle': { background: 'rgba(255, 255, 255, 0.44)' },
    '.os-no-css-vars.os-theme-light:hover .os-scrollbar-handle': { background: 'rgba(255, 255, 255, 0.55)' },
    '.os-no-css-vars.os-theme-light:active .os-scrollbar-handle': { background: 'rgba(255, 255, 255, 0.66)' }
  }),
  e = () => o.createElement(s, { styles: a }),
  p = e
export { p as default, a as getScrollAreaStyles }
//# sourceMappingURL=GlobalScrollAreaStyles-UY5SB7EJ-93836119.js.map
