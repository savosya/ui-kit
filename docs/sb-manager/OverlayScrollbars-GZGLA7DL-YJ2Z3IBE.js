...
function each(t2, n2) {
  if (isArrayLike(t2)) for (let o2 = 0; o2 < t2.length && n2(t2[o2], o2, t2) !== !1; o2++);
...
var createCache = (t2, n2) => {
  ...
  push = (t2, n2, o2) => (
    !o2 && !isString(n2) && isArrayLike(n2) ? Array.prototype.push.apply(t2, n2) : t2.push(n2), t2
  ),
  from = t2 => {
    let n2 = Array.from,
      o2 = []
  ...
  is = (t2, n2) => (isElement(t2) ? (s.matches || s.msMatchesSelector).call(t2, n2) : !1),
  ...
  liesBetween = (t2, n2, o2) => {
    let s2 = t2 && closest(t2, n2),
      ...
      c2 = closest(e2, n2) === s2
    return s2 && e2 ? s2 === t2 || e2 === t2 || (c2 && closest(closest(t2, o2), n2) !== s2) : !1
  },
  before = (t2, n2, o2) => {
    if (o2 && t2) {
      let s2 = n2,
  ...
  jsAPI = t2 => {
    if (isClient()) {
      ...
      return (
        hasOwnProperty(r, t2) || (each(c, o2 => ((n2 = n2 || window[o2 + firstLetterToUpper(t2)]), !n2)), (r[t2] = n2)),
        n2
      )
    }
  },
  ...
  addClass = (t2, n2) => (classListAction(t2, n2, (t3, n3) => t3.add(n3)), removeClass.bind(0, t2, n2)),
  equal = (t2, n2, o2, s2) => {
    if (t2 && n2) {
      let e2 = !0
      return (
  ...
  equalBCRWH = (t2, n2, o2) => equal(t2, n2, ['width', 'height'], o2 && (t3 => Math.round(t3))),
  noop = () => {},
  selfClearTimeout = t2 => {
    let n2,
      o2 = t2 ? _ : f,
  ...
  adaptCSSVal = (t2, n2) => (!w[t2.toLowerCase()] && isNumber(n2) ? `${n2}px` : n2),
  getCSSVal = (t2, n2, o2) => (n2 != null ? n2[o2] || n2.getPropertyValue(o2) : t2.style[o2]),
  setCSSVal = (t2, n2, o2) => {
    try {
      let { style: s2 } = t2
  ...
  getNativeScrollbarsHiding = t2 => {
    ...
    try {
      n2 =
        ...
        window.getComputedStyle(t2, '::-webkit-scrollbar').getPropertyValue('display') === 'none'
    } catch {}
    return o2(), n2
  },
  ...
  createEnvironment = () => {
    let { body: t2 } = document,
      ...
      d2 = {
        elements: { host: null, padding: !a2, viewport: t3 => a2 && t3 === t3.ownerDocument.body && t3, content: !1 },
        scrollbars: { slot: !0 },
    ...
    if ((removeAttr(o2, 'style'), removeElements(o2), g2('resize', w3.bind(0, !1)), !a2 && (!u2.x || !u2.y))) {
      let t3
      g2('resize', () => {
  ...
  createOptionCheck = (t2, n2, o2) => s2 => [getPropByPath(t2, s2), o2 || getPropByPath(n2, s2) !== void 0],
  createState = t2 => {
    let n2 = t2
    return [
      () => n2,
  ...
  createStructureSetupElements = t2 => {
    let n2 = getEnvironment(),
      ...
      at2 = b3 ? nt2 : contents([ct2, et2, st2, ot2, nt2].find(t3 => elementIsGenerated(t3) === !1)),
      ut2 = k2 ? nt2 : ct2 || et2
    return [
      Q2,
      () => {
        ...
        if (
          ...
          s2 && !M2 && (attrClass(et2, D, R, !0), push(it2, removeAttr.bind(0, et2, D))),
          rt2 && (insertBefore(et2, rt2), push(it2, removeElements.bind(0, rt2))),
          K2)
        ) {
          let t4 = attr(et2, Pt)
          attr(et2, Pt, '-1'), et2.focus()
          let revertViewportTabIndex = () => (t4 ? attr(et2, Pt, t4) : removeAttr(et2, Pt)),
  ...
  createPaddingUpdateSegment = (t2, n2) => {
    let [o2, s2] = n2,
      ...
      [l2, a2] = createCache({ u: equalTRBL, o: topRightBottomLeft() }, topRightBottomLeft.bind(0, e2, 'padding', ''))
    return (t3, n3, e3) => {
      let [u2, d2] = a2(e3),
  ...
  createOverflowUpdateSegment = (t2, n2) => {
    let [o2, s2] = n2,
      ...
      setViewportOverflowState = (t3, n3, o3, s3) => {
        ...
        return (
          (s3.overflowX = c3 && r3 ? c3 : e3), (s3.overflowY = i3 && e3 ? i3 : r3), getViewportOverflowState(t3, s3)
        )
      },
      hideNativeScrollbars = (t3, n3, s3, e3) => {
        ...
        ;(e3.width = `calc(100% + ${u3 + -1 * h3}px)`),
          ...
          s3 && ((e3[_3] = g3 + (l3 ? u3 : 0)), (e3.paddingBottom = w4 + (i3 ? a3 : 0)))
      },
      [H2, P2] = g2
    ...
    return (t3, n3, i3) => {
      ...
      let [et2, ct2] = ot2,
        ...
        _t2 = (Z2 && J2 && (ft2.x || ft2.y)) || (Z2 && ft2.x && !ft2.y) || (J2 && ft2.y && !ft2.x)
      if (w4 || Y2 || dt2 || at2 || ct2 || it2 || X2 || F3 || W2) {
        let t4 = { marginRight: 0, marginBottom: 0, marginLeft: 0, width: '', overflowY: '', overflowX: '' },
          n4 = setViewportOverflowState(U2, ft2, G2, t4),
          o3 = H2(n4, lt2, ut2, N2)
        l2 || hideNativeScrollbars(n4, N2, o3, t4),
          W2 && fixFlexboxGlue(n4, j2),
          l2 ? (attr(e2, E, t4.overflowX), attr(e2, I, t4.overflowY)) : style(r2, t4)
      }
      attrClass(e2, T, A, _t2), attrClass(c2, B, V, _t2), l2 || attrClass(r2, D, k, K2)
      let [ht2, vt2] = z2(getViewportOverflowState(U2).Ct)
      return (
        s2({ Ct: ht2, zt: { x: et2.w, y: et2.h }, Tt: { x: rt2.w, y: rt2.h }, Et: ft2 }), { It: vt2, At: ct2, Lt: it2 }
      )
    }
  },
  ...
  createStructureSetupUpdate = (t2, n2) => {
    let { W: o2, J: s2, _t: e2, ut: c2 } = t2,
      ...
      a2 = !r2 && (i2.x || i2.y),
      u2 = [createTrinsicUpdateSegment(t2, n2), createPaddingUpdateSegment(t2, n2), createOverflowUpdateSegment(t2, n2)]
    return (t3, n3, r3) => {
      let i3 = prepareUpdateHints(
          assignDeep({ gt: !1, xt: !1, yt: !1, vt: !1, At: !1, Lt: !1, It: !1, Ot: !1, wt: !1 }, n3),
          {},
          r3
        ),
        d2 = a2 || !l2,
  ...
  createEventContentChange = (t2, n2, o2) => {
        ...
        if (o2) {
          let r2 = o2.reduce((n3, o3) => {
            if (o3) {
              ...
              r3 && r3.length && e3 && isString(e3) && push(n3, [r3, e3.trim()], !0)
            }
            return n3
          }, [])
          each(r2, o3 =>
    ...
    return o2 && ((s2 = new WeakMap()), updateElements()), [destroy, updateElements]
  },
  createDOMObserver = (t2, n2, o2, s2) => {
    let e2 = !1,
      ...
      observerCallback = (e3, c3) => {
        ...
        if (
          (each(e3, o3 => {
            let { attributeName: e4, target: c4, type: u3, oldValue: d3, addedNodes: h3, removedNodes: w4 } = o3,
              p3 = u3 === 'attributes',
              b3 = u3 === 'childList',
              m2 = t2 === c4,
            ...
            if (n2 && (b3 || !m2)) {
              let n3 = !p3,
                u4 = p3 && S3,
                f5 = u4 && a2 && is(c4, a2),
                g3 = (f5 ? !r3(c4, e4, d3, y2) : n3 || u4) && !i3(o3, !!f5, t2, s2)
              each(h3, t3 => l2.add(t3)), each(w4, t3 => l2.add(t3)), (v4 = v4 || g3)
            }
            !n2 && m2 && S3 && !r3(c4, e4, d3, y2) && (f4.add(e4), (_3 = _3 || x2))
          }),
          l2.size > 0 &&
            h2(t3 => from(l2).reduce((n3, o3) => (push(n3, find(t3, o3)), is(o3, t3) ? push(n3, o3) : n3), [])),
          n2)
        )
          return !c3 && v4 && o2(!1), [!1]
        if (f4.size > 0 || _3) {
  ...
  isHeightIntrinsic = t2 => t2.h === 0 || t2.isIntersecting || t2.intersectionRatio > 0,
  createTrinsicObserver = (t2, n2) => {
    let o2,
      ...
      intersectionObserverCallback = (t3, n3) => {
        if (t3 && t3.length > 0) return triggerOnTrinsicChangedCallback(t3.pop(), n3)
      }
    return [
      () => {
  ...
  createStructureSetupObservers = (t2, n2, o2) => {
    let s2,
      ...
      [p2, b3, m2] = l2 || !h2 ? createTrinsicObserver(r2, onTrinsicChanged) : [noop, noop, noop],
      [y2, S3] = d2 ? [noop, noop] : createSizeObserver(r2, onSizeChanged, { Vt: !0, Bt: !0 }),
      [x2, $2] = createDOMObserver(r2, !1, onHostMutation, { Pt: Ut, Ht: Ut.concat(Gt) }),
  ...
  createStructureSetup = (t2, n2) => {
    let o2 = createOptionCheck(n2, {}),
      ...
      [_2, h2, v3, g2] = createStructureSetupObservers(r2, d2, t3 => triggerUpdateEvent(f3(o2, t3), {}, !1)),
      w3 = u2.bind(0)
    return (
      (w3.jt = t3 => s2('u', t3)),
      (w3.Nt = () => {
  ...
  createRootClickStopPropagationEvents = (t2, n2) =>
    on(t2, 'mousedown', on.bind(0, n2, 'click', stopPropagation, { C: !0, $: !0 }), { $: !0 }),
    ...
    return on(a2, 'pointerdown', s3 => {
      ...
      if ((attrClass(n2, T, H, !0), continuePointerDown(s3, t2, c3))) {
        let t3 = !c3 && s3.shiftKey,
          ...
          getHandleOffset = (t4, n3) => (t4 || getHandleRect())[h2] - (n3 || getTrackRect())[h2],
    ...
    return runEachAndClear.bind(0, [
      ...
      on(
        ...
        t3 => {
          ...
          d2 && f3 && e3 === 0 && parent(l2) === c2 && r2.scrollBy({ left: n3, top: o3, behavior: 'smooth' }),
            (f3 = !1),
            s2(at, !0),
            a2(() => {
              ;(f3 = !0), s2(at)
  ...
  createScrollbarsSetupElements = (t2, n2, o2) => {
    let { N: s2, L: e2 } = getEnvironment(),
      ...
      { scrollbars: g2 } = d2 ? {} : t2,
      { slot: w3 } = g2 || {},
      p2 = dynamicInitializationElement([l2, a2, u2], () => (v3 && h2 ? l2 : a2), r2, w3),
      ...
      scrollbarStructureRefreshHandleOffset = (t3, n3, o3) => {
        ...
        scrollbarsHandleStyle(t3, t4 => {
          let { Ft: e3, Gt: c3, Xt: r3 } = t4,
            i3 = getScrollbarHandleOffsetRatio(e3, c3, f3, n3, directionIsRTL(r3), o3)
      ...
      refreshScrollbarsHandleLength = t3 => {
        scrollbarStructureRefreshHandleLength(m2, t3, !0), scrollbarStructureRefreshHandleLength(y2, t3)
      },
      refreshScrollbarsHandleOffset = t3 => {
        scrollbarStructureRefreshHandleOffset(m2, t3, !0), scrollbarStructureRefreshHandleOffset(y2, t3)
      },
      generateScrollbarDOM = t3 => {
        ...
        return (
          ...
          push(s3, d3),
          push(b3, [removeElements.bind(0, r3), o2(d3, scrollbarsAddRemoveClass, i2, a2, f3, t3)]),
          d3
        )
      },
  ...
  createScrollbarsSetup = (t2, n2, o2, s2) => {
    let e2,
      ...
      [S3, x2, $2] = createScrollbarsSetupElements(t2, o2.qt, createScrollbarsSetupEvents(n2, o2)),
      ...
      [
        (t3, s3, i3) => {
          ...
          if (
            ...
            z3 &&
              ((e2 = O4 === 'move'), (c2 = O4 === 'leave'), (r2 = O4 !== 'never'), manageScrollbarsAutoHide(!r2, !0)),
            A4 && H2(dt, E4),
            M3 && H2(ut, L3),
            k3)
          ) {
          ...
          R3 && (P2(g3), D2(g3), H2(it, !w4.x, !0), H2(it, !w4.y, !1), H2(K, b4 && !I2))
        },
        B2,
  ...
  OverlayScrollbars = (t2, n2, o2) => {
    ...
    if (n2 && !u2) {
      let u3 = !1,
        ...
        [p2, b3, m2] = createScrollbarsSetup(t2, d2, g2, t3 => h2('scroll', [$2, t3])),
        update = (t3, n3) => v3(t3, !!n3),
        y2 = update.bind(0, {}, !0),
        S3 = c2(y2),
        x2 = r2(y2),
        destroy = t3 => {
          removeInstance(a2), S3(), x2(), m2(), w3(), (u3 = !0), h2('destroyed', [$2, !!t3]), _2()
        },
        $2 = {
          options(t3, n3) {
            if (t3) {
...
var O2 = () => {
  ...
  S2 = l2 => {
    ...
    return (
      ...
      (0, import_react.useEffect)(() => {
        let { current: e2 } = r2
        ;(s2.current = c2), OverlayScrollbars.valid(e2) && e2.options(c2 || {}, !0)
      }, [c2]),
      (0, import_react.useEffect)(() => {
        let { current: e2 } = r2
  ...
  F2 = (l2, c2) => {
    let { element: t2 = 'div', options: o2, events: a2, defer: i2, children: r2, ...u2 } = l2,
      s2 = t2,
    ...
    return (
      ...
      (0, import_react.useImperativeHandle)(c2, () => ({ osInstance: d2, getElement: () => n2.current }), []),
